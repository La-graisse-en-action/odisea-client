...
export default function WelcomePage({ navigation }: ParamListBase) {
  return (
    <ImageBackground
    ...
    >
      <Layout customThemes="justify-between">
        <Fade>
          <View>
            <Text className="text-4xl flex flex-row items-center font-bold text-center">
              <Text className="text-white shadow-sm">Hey!</Text> Welcome to your
              Journey
            </Text>
          </View>
        </Fade>
        <View>
          ...
          <View className="mt-6">
            <Text className="text-center text-xs font-semibold mx-auto text-[#505050] mb-[5px]">
